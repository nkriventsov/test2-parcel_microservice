...
class RedisManager:
    ...
    async def connect(self):
        ...
        logger.debug(f"[RedisManager.connect] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        try:
    ...
    async def _ensure_connected(self):
        ...
        logger.debug(f"[RedisManager._ensure_connected] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
    ...
    async def set(self, key: str, value: str, expire: int | None = None):
        ...
        """
        logger.debug(f"[RedisManager.set] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
    ...
    async def get(self, key: str):
        ...
        """
        logger.debug(f"[RedisManager.get] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        await self._ensure_connected()
        try:
    ...
    async def delete(self, key: str):
        ...
        """
        logger.debug(f"[RedisManager.delete] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        await self._ensure_connected()
        try:
    ...
    async def close(self):
        ...
        logger.debug(f"[RedisManager.close] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        if self._redis:
            try:
