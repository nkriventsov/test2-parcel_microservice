...
class DBManager:
    ...
    async def __aenter__(self):
        ...
        logger.debug(f"[DBManager.__aenter__] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        try:
    ...
    async def __aexit__(self, *args):
        logger.debug(f"[DBManager.__aexit__] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        try:
    ...
    async def commit(self):
        logger.debug(f"[DBManager.commit] Цикл событий: ID={id(asyncio.get_running_loop())} | Объект={asyncio.get_running_loop()}")
        try:
